...
//custom hook to handle infinite scrolling in case loading all records
const useInfiniteScroll = (callback, isFetching) => {
    ...
    const lastElementRef = useCallback(
        (node) => {
            ...
            //create a new intersection observer and execute the callback in case of an intersecting event
